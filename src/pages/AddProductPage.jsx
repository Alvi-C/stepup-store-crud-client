...
const AddProductPage = () => {
	const handleAddProduct = e => {
		...
		console.log(image, name, brand, type, price, description, ratings)
	...
	return (
		<div className='flex flex-col md:flex-row items-center justify-center gap-10 px-3 mb-10'>
			<div className='order-2 md:order-1'>
				<img
					src='https://www.gngmodels.com/wp-content/uploads/2022/10/female-footwear-photoshoot-2-682x1024.jpg'
					className='rounded-2xl object-cover w-full md:w-80'
					alt='page img'
				/>
			</div>
			<div className='relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none order-1 md:order-2'>
				...
				>
					<div className='mb-4 flex flex-col gap-6'>
						...
						<div className='relative h-11 w-full min-w-[200px]'>
							...
							>
								...
								<option value='Oxford'>Oxford Shoe</option>
					...
					<input
						className='mt-6 block w-full select-none rounded-lg bg-black py-3 px-6 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-pink-500/20 transition-all hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none'
						type='submit'
						value='Add Product'
					/>
				</form>
